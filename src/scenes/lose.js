class Lose extends Phaser.Scene {
    ...
    create(){
        ...
        this.add.text(game.config.width / 2, (game.config.height / 2) + (borderPadding * 3), "The high score is " + highScore, textConfigWhite).setOrigin(0.5);
        this.add.text(game.config.width / 2, game.config.height - (borderUISize + borderPadding), "press R to restart or SPACE to return to menu", textConfigWhite).setOrigin(0.5);
